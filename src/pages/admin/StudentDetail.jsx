...
export default function StudentDetail() {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case 'Active':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-medium bg-emerald-50 text-emerald-800 border border-emerald-200 inline-flex items-center gap-1.5 shadow-xs">
      ...
      case 'Inactive':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-medium bg-slate-100 text-slate-700 border border-slate-200 inline-flex items-center gap-1.5 shadow-xs">
      ...
      case 'Alumni':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-medium bg-purple-50 text-purple-800 border border-purple-200 inline-flex items-center gap-1.5 shadow-xs">
            <span className="material-symbols-outlined text-[14px] text-purple-700">school</span>
            Alumni
          </span>
        );
      case 'Suspended':
        return (
          <span className="px-3 py-1 rounded-full text-xs font-medium bg-rose-50 text-rose-800 border border-rose-200 inline-flex items-center gap-1.5 shadow-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              ...
              <span className="font-semibold text-primary flex items-center gap-1">
                ...
                {student.branch || 'Main Center (Bagru)'}
              </span>
            </div>
            <div>
